        ...
        <div className="container">
            <div className="container-information">
                ...
                <div className='from'>
                    ...
                    <h3 className='text'>Precisamos de sua ajuda para ressurgir, você topa a missão??</h3>
                    <div>
                ...
                <div className='from2'>
                    ...
                    <p className='text'>
                        Fizemos um software de afazeres, para que você possa deixar 
                        o planejamento do seu dia, mas com o objetivo de deixa-lo mais dimânico, 
                        colocamos uma gamificação para fazer o usuário sempre cumprir com o que 
                        ele mesmo se propõe a fazer.
                        Para não dar mais spoiler faça seu login e venha se divertir fazendo suas tarefas!!!!
                    </p>
                </div>
            </div>
        </div>
